...
class EfficientNet(nn.Module):
    def __init__(self, n_channels):
        ...
        # checkpoint = torch.load("/media/ymo/1TB Disk/pythonProject/SportsFieldRegistration/checkpoints/efficientnetv2-s-21k-ft1k.tgz")
        # pre_weight = checkpoint['model_state']
        # print("pre_weight : ", pre_weight)
        # model_dict = self.efficient_model.state_dict()
        # pretrained_dict = {"module." + k: v for k, v in pre_weight.items() if "module." + k in model_dict}
        # model_dict.update(pretrained_dict)
        # self.efficient_model.load_state_dict(model_dict)
